                  ...
                  <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="card text-center" style="width: 18rem;">
                            <div class="card-body">
                            <h5 class="card-title">Svolgere la query 1</h5>
                            <p class="card-text">Eventi del prossimo mese</p>
                            <a href="query1.php" class="btn btn-primary">QUERY 1</a>
                            </div>
                        </div>
                        </div>
                        <div class="col">
                            <div class="card text-center" style="width: 18rem;">
                                <div class="card-body">
                                <h5 class="card-title">Svolgere la query 2</h5>
                                <p class="card-text">Evento con il minor numero di ingressi</p>
                                <a href="query2.php" class="btn btn-primary">QUERY 2</a>
                                </div>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="card text-center" style="width: 18rem;">
                            <div class="card-body">
                            <h5 class="card-title">Svolgere la query 3</h5>
                            <p class="card-text">Personale che potrebbe sostituire un addetto</p>
                            <a href="query3.php" class="btn btn-primary">QUERY 3</a>
                            </div>
                        </div>
                        </div>
                  </div>
