...
<html lang="en">
    ...
    <?php
            ...
            try{
                ...
                if($idCitta == ""){
                    header("location: aggiungiLuogo.php?message=Città+o+CAP+sbagliati");
                }else{
                    ...
                    if($idLuogo == ""){
                        ...
                        header("location: aggiungiLuogo.php?message=Il+luogo+è+già+registrato+in+questa+città");
                    }
                }
