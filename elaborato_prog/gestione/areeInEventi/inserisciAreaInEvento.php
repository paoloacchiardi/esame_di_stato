                ...
                if($res2 == ""){
                    ...
                    if($res == ""){
                        ...
                        if($res == ""){
                            ...
                            //area esistente, evento esistente, area già inserita in questo evento
                            header("location: inserisciAreaInEvento.php?message=Area+già+presente+in+questo+evento");
                        }
                    }
                }
